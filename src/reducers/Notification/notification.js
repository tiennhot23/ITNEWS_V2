    ...
    async () => {
        try {
            const response = await axios.get(
                `https://itnews-api.herokuapp.com/api/v1/notification/all`
            )
...
export const getNotification = createAsyncThunk(
    ...
    async (id_notification) => {
        try {
            const response = await axios.get(
                `https://itnews-api.herokuapp.com/api/v1/notification/${id_notification}`
            )
            if (response.status === 200) {
                return await { ...response.data, status: response.status }
            }
...
export const readNotification = createAsyncThunk(
    ...
    async (id_notification) => {
        try {
            const response = await axios.get(
                `https://itnews-api.herokuapp.com/api/v1/notification/${id_notification}/read`
            )
            if (response.status === 200) {
                return await {
                    ...response.data,
