    ...
    async () => {
        try {
            const response = await axios.get(
                "https://itnews-api.herokuapp.com/api/v1/post/browse"
            )
...
export const fetchPostUser = createAsyncThunk(
    ...
    async (id_account) => {
        try {
            const response = await axios.get(
                `https://itnews-api.herokuapp.com/api/v1/account/${id_account}/posts`
            )
            if (response.status === 200) {
                return await { ...response.data, status: response.status }
            }
    ...
    async (data) => {
        try {
            const response = await axios.put(
                `https://itnews-api.herokuapp.com/api/v1/post/${data.id_post}/status/${data.status}`
            )
            if (response.status === 200) {
                return await {
                    ...response.data,
...
export const searchPost = createAsyncThunk(
    ...
    async (keyword) => {
        try {
            const response = await axios.get(
                `https://itnews-api.herokuapp.com/api/v1/post/search?k=${keyword}`
            )
            if (response.status === 200) {
                return await {
                    ...response.data,
...
export const fetchPNews = createAsyncThunk(
    ...
    async () => {
        try {
            const response = await axios.get(
                `https://itnews-api.herokuapp.com/api/v1/post/newest`
            )
            if (response.status === 200) {
                return await {
                    ...response.data,
